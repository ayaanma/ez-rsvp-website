...
export const events: EventItem[] = [
  ...
  },
  {
    ...
    category: "nightlife",
    description:
      "A polished Midtown venue experience with lounge energy, reserved entry, and a curated night built around food, music, and an easy arrival plan.",
...
export const pastEvents: PastEvent[] = [
  {
    ...
    address: "148 Lafayette Street, New York, NY",
    wouldDoAgain: "Would do again — great vibe, easy entry, perfect surprise level.",
  },
  {
    id: "past-2",
    name: "Neon Gallery",
    ...
    address: "37 Walker Street, New York, NY",
    wouldDoAgain: "Would do again — quiet, pretty, and fun with friends.",
  },
  {
    id: "past-3",
    ...
    address: "412 West Broadway, New York, NY",
    wouldDoAgain: "Maybe — food was excellent, but the commute was long.",
  },
];
...
export const groups: Group[] = [
  {
    ...
    upcomingDateTime: "July 7th at 8 PM",
    memberStatuses: { m1: "RSVP'd yes", m2: "Haven't RSVP'd yet", m3: "Haven't RSVP'd yet", m4: "RSVP'd yes" },
  },
  {
    id: "g2",
    name: "Rutgers Crew",
    members: [members[3], members[0], members[1]],
    readiness: 66,
    code: "RUKNGT",
    role: "Member",
    icon: "◈",
    upcomingPlan: "Mystery plan",
    upcomingDateTime: "July 12th at 7 PM",
    memberStatuses: { m4: "RSVP'd yes", m1: "RSVP'd no", m2: "RSVP'd yes" },
  },
];
