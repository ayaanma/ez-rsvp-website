...
export default function HomePage() {
  ...
  return (
    <main className="main-shell home-page">
      <section className="hero">
        <div>
          ...
          <div className="hero-actions">
            ...
            <a className="app-store-link" href="/download" aria-label="Download on the App Store">
              <Image
        ...
        <div className="showcase-card plain-showcase">
          <RSVPCard event={previewEvent} locked hideCategory hiddenTitle="Awaiting reveal" />
        </div>
      </section>
      ...
      <section className="section anticipation-band">
        <div className="anticipation-copy">
          <h2 className="section-title">Anticipation is part of the experience.</h2>
          <p className="section-copy">
            Mystery cards keep details hidden until the right moment. You always know the price, safety rules, and your hard limits before committing.
          </p>
          <div className="chip-row anticipation-chips">
        ...
        <div className="anticipation-preview">
      ...
      <section className="section safety-section">
        ...
        <div className="grid-2">
          <article className="card">
            ...
            <p className="section-copy">No unsafe or private locations. Every plan is hosted at a vetted public space.</p>
          </article>
          ...
          <article className="card">
            ...
            <p className="section-copy">Organizer details, capacity, age rules, and accessibility notes are tracked for every event.</p>
          </article>
        </div>
      </section>
